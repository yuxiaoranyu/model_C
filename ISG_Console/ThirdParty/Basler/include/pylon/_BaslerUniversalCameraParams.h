...
namespace Basler_UniversalCameraParams
{
    ...
    {
        BinningSelector_Region1,  //!< FPGA binning can be configured - Applies to: boost CoaXPress and dart 2 USB
    ...
    {
        BslPeriodicSignalSource_DeviceClock,  //!< The camera is synchronized via the device clock - Applies to: ace 2 GigE
        BslPeriodicSignalSource_PtpClock  //!< The camera is synchronized via the PTP clock - Applies to: ace 2 GigE
    };
    ...
    {
        BslSensorState_Off,  //!< The sensor power is switched off - Applies to: boost CoaXPress and dart 2 USB
        BslSensorState_On,  //!< The sensor power is switched on - Applies to: boost CoaXPress and dart 2 USB
        BslSensorState_Standby  //!< The sensor is in standby mode - Applies to: boost CoaXPress and dart 2 USB
    };
    ...
    enum CounterEventSourceEnums
    {
        ...
        CounterEventSource_ExposureStart,  //!< The selected counter counts the number of Exposure Start signals - Applies to: CameraLink, GigE, boost CoaXPress and dart 2 USB
    ...
    enum CounterResetSourceEnums
    {
        ...
        CounterResetSource_ExposureStart,  //!< The selected counter can be reset by an Exposure Start signal - Applies to: boost CoaXPress and dart 2 USB
    ...
    enum CounterTriggerSourceEnums
    {
        ...
        CounterTriggerSource_ExposureStart,  //!< The selected counter can be started by an Exposure Start signal - Applies to: boost CoaXPress and dart 2 USB
    ...
    {
        DefectPixelCorrectionMode_Off,  //!< Applies to: dart BCON, dart USB and pulse USB
        DefectPixelCorrectionMode_On,  //!< Applies to: dart BCON, dart USB and pulse USB
        DefectPixelCorrectionMode_StaticOnly  //!< Applies to: dart BCON, dart USB and pulse USB
    };
    ...
    enum LineModeEnums
    {
        LineMode_InOut,  //!< The selected physical line can be used to input and output an electrical signal - Applies to: boost CoaXPress and dart 2 USB
    ...
    enum SensorShutterModeEnums
    {
        ...
        SensorShutterMode_Rolling  //!< The shutter opens and closes sequentially for groups of rows - Applies to: ace 2 GigE, ace 2 USB, dart 2 USB, dart BCON, dart USB and pulse USB
    };
    ...
    enum TimerTriggerSourceEnums
    {
        ...
        TimerTriggerSource_ExposureStart,  //!< The selected timer can be started by an Exposure Start signal - Applies to: CameraLink, GigE, ace USB, boost CoaXPress and dart 2 USB
    ...
    //**************************************************************************************************
    // Parameter class CUniversalCameraParams_Params_v6_3_0
    //**************************************************************************************************
    ...
    The \ref sample_ParametrizeCamera_NativeParameterAccess code sample shows how to access camera parameters via the \c Pylon::CBaslerUniversalInstantCamera class.
    */
    class PYLONBASE_API CUniversalCameraParams_Params_v6_3_0
    {
    //----------------------------------------------------------------------------------------------------------------
    // Implementation
    //----------------------------------------------------------------------------------------------------------------
    ...
    //! \cond HIDE_CLASS_METHODS
        ...
        //! Constructor
        CUniversalCameraParams_Params_v6_3_0( void );
    ...
    private:
        class CUniversalCameraParams_Params_v6_3_0_Data;
        CUniversalCameraParams_Params_v6_3_0_Data* m_pCUniversalCameraParams_Params_v6_3_0_Data;
    ...
    public:
        ...
        */
        ...
        //@{
        /*!
            \brief Sets whether sensor or FPGA binning can be configured - Applies to: boost CoaXPress and dart 2 USB
            ...
            The <a href="https://docs.baslerweb.com/?rhcsh=1&rhmapid=BinningSelector" target="_blank">Basler Product Documentation</a> may provide more information.
        */
        ...
        */
        ...
        /*!
            ...
            The <a href="https://docs.baslerweb.com/?rhcsh=1&rhmapid=BslBlackLevelCompensationMode" target="_blank">Basler Product Documentation</a> may provide more information.
        */
        ...
        */
        ...
        //@{
        /*!
            \brief Current exposure time - Applies to: boost CoaXPress
        ...
        */
        ...
        //@{
        /*!
            \brief Exposure start delay with current settings - Applies to: boost CoaXPress and dart 2 USB
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the source for synchronizing the periodic signal - Applies to: ace 2 GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Switches the sensor power off - Applies to: boost CoaXPress
        ...
        */
        ...
        //@{
        /*!
            \brief Switches the sensor power on - Applies to: boost CoaXPress
        ...
        */
        ...
        //@{
        /*!
            \brief Puts the sensor in standby mode - Applies to: boost CoaXPress
        ...
        */
        ...
        //@{
        /*!
            \brief Returns the current power state of the sensor - Applies to: boost CoaXPress and dart 2 USB
        ...
        */
        ...
        //@{
        /*!
            \brief Speed of transmission negotiated on the selected link - Applies to: ace USB, boost CoaXPress, dart 2 USB, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Digital shift to be applied - Applies to: CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress and dart 2 USB
        ...
        */
        ...
        //@{
        /*!
            \brief Unique identifier of the Overrun event  Use this parameter to get notified when the event occurs - Applies to: ace 2 GigE, ace 2 USB and dart 2 USB
  ...
  errors causing planar surfaces to appear curved.
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the shutter mode of the camera - Applies to: ace 2 GigE, ace 2 USB, dart 2 USB, dart BCON, dart USB and pulse USB
    ...
    //! \cond HIDE_CLASS_METHODS
        ...
        CUniversalCameraParams_Params_v6_3_0(CUniversalCameraParams_Params_v6_3_0&);

        //! not implemented assignment operator
        CUniversalCameraParams_Params_v6_3_0& operator=(CUniversalCameraParams_Params_v6_3_0&);
    ...
    The \ref sample_ParametrizeCamera_NativeParameterAccess code sample shows how to access camera parameters via the \c Pylon::CBaslerUniversalInstantCamera class.
    */
    class CUniversalCameraParams_Params : public CUniversalCameraParams_Params_v6_3_0
    {
    //----------------------------------------------------------------------------------------------------------------
    // Implementation
    //----------------------------------------------------------------------------------------------------------------
    protected:
        ...
        {
            CUniversalCameraParams_Params_v6_3_0::_Initialize( pNodeMap );
        }
        //! \endcond
    };
} // namespace Basler_UniversalCameraParams
